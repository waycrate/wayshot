...
use image::{ColorType, ColorType::Rgba8};
...
// Types of frames supported by the compositor.
...
// State of the frame after attemting to copy it's data to a wlbuffer.
#[derive(Debug, Copy, Clone, PartialEq)]
enum FrameState {
    Failed,
    Finished,
...
// The copied frame that we return.
#[derive(Debug)]
